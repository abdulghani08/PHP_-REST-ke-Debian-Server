...
{	private $url;
	...
	// function yang pertama kali di-load saat calss dipanggil
	...
	// function yang terakhir kali di -load saat class di panggil
...
$url = 'http://192.169.56.85/restful-xml-toko/server/server.php';
